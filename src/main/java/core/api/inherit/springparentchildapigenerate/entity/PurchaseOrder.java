...
public class PurchaseOrder { 
    ...
    @JoinColumn(name = "DEPARTMENT_ID", referencedColumnName = "id", foreignKey=@ForeignKey(name = "FK_Department_Department_ID"), unique = false, nullable = false, updatable = false )
    @ManyToOne(optional = false, cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @Getter
    @Setter
