...
public class PurchaseRequisitionLine { 
    ...
    @JoinColumn(name = "REQUISITION_ID", referencedColumnName = "id", foreignKey=@ForeignKey(name = "FK_PurchaseRequisition_Requisition_ID"), unique = false, nullable = true, updatable = true )
