...
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (1, 'asset', 'Y', '1', 'IDR', 'view', 'Balance Sheet', 'Balance Sheet', 1, null);
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (2, 'asset', 'Y', '2', 'IDR', 'view', 'Balance Short', 'Balance Short', 1, 1);
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (3, 'asset', 'Y', '3', 'IDR', 'view', 'Balance Looks', 'Balance Looks', 1, 2);
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (4, 'asset', 'Y', '4', 'IDR', 'view', 'Balance Goods', 'Balance Goods', 1, null);
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (5, 'asset', 'Y', '5', 'IDR', 'view', 'Balance Long', 'Balance Long', 1, 1);
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (6, 'asset', 'Y', '6', 'IDR', 'view', 'Balance Integer', 'Balance Integer', 1, 1);
INSERT INTO ACCOUNT
(id, account_type, active_status, code, currency, internal_type, name, note, company_id, parent_id)
VALUES (7, 'asset', 'Y', '7', 'IDR', 'view', 'Balance String', 'Balance String', 1, 6);
